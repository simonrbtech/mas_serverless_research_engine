...
task_research_revenue = Task(
    ...
    1) Search for the average monthly rental price for an e-bike ONLY with the search term 'average monthly price for e-bike rental'.
    2) Use those values to create a timeseries that ranges from the year 2025 to the end of 2030 with aggregate values FOR EACH MONTH. 
    In your estimates use the information that we plan to have 600 loyal customers in the first year and 
    that this number grows by 100 customers per year. Also add 150.000€ on top of the december revenue of each year, which we can achieve by selling
    100 of our older bikes at the end of each year on the second-hand market. Finally at the end of 2030 we will sell the rest of the e-bike inventory for 500.000€.  
